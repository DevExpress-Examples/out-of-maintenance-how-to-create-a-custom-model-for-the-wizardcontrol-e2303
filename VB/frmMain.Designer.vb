...
Namespace DevExpress.XtraWizard.Demos
	Partial Public Class frmMain
		...
		Private Sub InitializeComponent()
			...
			Me.wizardControl1 = New WindowsApplication1.MyWizardControl()
...
'			Me.wizardControl1.SelectedPageChanged += New DevExpress.XtraWizard.WizardPageChangedEventHandler(Me.wizardControl1_SelectedPageChanged);
'			Me.wizardControl1.FinishClick += New System.ComponentModel.CancelEventHandler(Me.wizardControl1_FinishClick);
'			Me.wizardControl1.CancelClick += New System.ComponentModel.CancelEventHandler(Me.wizardControl1_CancelClick);
			' 
			' welcomeWizardPage1
			' 
			...
			Me.pictureEdit1.Size = New System.Drawing.Size(496, 201)
			...
			Me.labelControl1.Size = New System.Drawing.Size(496, 0)
			Me.labelControl1.TabIndex = 0
			Me.labelControl1.Text = "Thank you for evaluating XtraWizard! This demo application will generate a birthd" & "ay card for you, all the while showing off many features of our wizard control, " & "including the Windows Aero layout."
			' 
			' wpRecipientData
			' 
...
'			Me.teEmail.InvalidValue += New DevExpress.XtraEditors.Controls.InvalidValueExceptionEventHandler(Me.teEmail_InvalidValue);
'			Me.teEmail.TextChanged += New System.EventHandler(Me.teRecipient_TextChanged);
			' 
			' teRecipientName
			' 
...
'			Me.teRecipientName.TextChanged += New System.EventHandler(Me.teRecipient_TextChanged);
			' 
			' labelControl3
			' 
			...
			Me.labelControl3.Size = New System.Drawing.Size(496, 0)
			...
			Me.labelControl2.Size = New System.Drawing.Size(496, 0)
			Me.labelControl2.TabIndex = 1
			Me.labelControl2.Text = "Please enter the recipient’s name as you’d like to see it on the birthday card:" & Constants.vbCrLf & ""
			' 
			' wpCardTemplate
			' 
			...
			Me.labelControl4.Size = New System.Drawing.Size(496, 0)
			Me.labelControl4.TabIndex = 2
			Me.labelControl4.Text = "Please select a birthday wish from the list below:" & Constants.vbCrLf
			' 
			' wpSignature
			' 
...
'			Me.sbSkipSignature.Click += New System.EventHandler(Me.sbSkipSignature_Click);
			' 
			' teYourName
			' 
...
'			Me.teYourName.TextChanged += New System.EventHandler(Me.teYourName_TextChanged);
			' 
			' labelControl6
			' 
			...
			Me.labelControl6.Size = New System.Drawing.Size(496, 0)
			...
			Me.labelControl5.Size = New System.Drawing.Size(496, 0)
			Me.labelControl5.TabIndex = 3
			Me.labelControl5.Text = "Please select a signature template from the list below:" & Constants.vbCrLf
			' 
			...
			Me.labelControl9.Location = New System.Drawing.Point(0, 201)
			Me.labelControl9.Name = "labelControl9"
			Me.labelControl9.Size = New System.Drawing.Size(496, 0)
			...
			Me.labelControl8.Size = New System.Drawing.Size(496, 0)
			Me.labelControl8.TabIndex = 5
			Me.labelControl8.Text = "We want to thank you once again for trying this demo and hope you enjoyed the bir" & "thday card we created for you."
			' 
			' wpPreview
			' 
...
'			Me.sbSend.Click += New System.EventHandler(Me.sbSend_Click);
			' 
			' meCard
			' 
			...
			Me.labelControl7.Size = New System.Drawing.Size(496, 0)
			Me.labelControl7.TabIndex = 4
			Me.labelControl7.Text = "Here's your birthday card preview:" & Constants.vbCrLf
			' 
			' frmMain
			' 
			...
			Me.Text = "XtraWizard Demo (WizardAero  Style, C# code)"
'			Me.FormClosing += New System.Windows.Forms.FormClosingEventHandler(Me.frmMain_FormClosing);
		...
		Private WithEvents wizardControl1 As MyWizardControl
